...
PressurePlate::PressurePlate(float x, float y) : DrawAble(x,y,(int)TimeWarriorZValues::PRESSUREPLATE,0,0,Util::getTextureIndex(TimeWarriorTexture::PressurePlateUp)), collidable_(Collidable(this))
{
    this->height(50);
    this->width(50);
}
